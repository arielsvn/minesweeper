...
define('text!templates/table-container-template.html',[],function () { return '<table>\r\n    <%for (var i=0;i < rows; i++) {%>\r\n    <tr>\r\n        <%for (var j=0;j < cols; j++) {%>\r\n        <th data-row=<%=i%> data-col=<%=j%> >\r\n            <div id="cell-content" class="hidden"></div>\r\n        </th>\r\n        <%}%>\r\n    </tr>\r\n    <%}%>\r\n</table>';});
...
define('views/cellstate',['jquery', 'underscore', 'backbone'], function() {
  return {
    empty: 'empty',
    hidden: 'hidden',
    info: 'info',
...
define('views/cell',['views/cellstate', 'jquery', 'underscore', 'backbone'], function(CellState) {
  var Cell;
...
define('views/game',['views/cell', 'views/cellstate', 'text!templates/table-container-template.html', 'jquery', 'underscore', 'backbone'], function(Cell, CellState, tableTemplate) {
